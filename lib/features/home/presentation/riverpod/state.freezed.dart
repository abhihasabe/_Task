...
abstract class $StateCopyWith<T, $Res> {
  factory $StateCopyWith(HomeState<T> value, $Res Function(HomeState<T>) then) =
      _$StateCopyWithImpl<T, $Res, HomeState<T>>;
}

/// @nodoc
class _$StateCopyWithImpl<T, $Res, $Val extends HomeState<T>>
...
abstract class _init<T> extends HomeState<T> {
...
abstract class _loading<T> extends HomeState<T> {
...
abstract class _success<T> extends HomeState<T> {
...
abstract class _error<T> extends HomeState<T> {
